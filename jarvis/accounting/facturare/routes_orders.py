...
from .services.advance_alloc import (  # pure per-car advance math, shared with the state machine
...
def api_get_anexa_detail(anexa_id):
    ...
    for r in unpaired_raw:
        ...
        unpaired.append({
            ...
            "line_ids": raw_lids,
            # Proforma lines not yet confirmed by an advance invoice — drives the
            # per-car selection when only part of a proforma has been paid.
            "remaining_line_ids": r.get("remaining_line_ids"),
        })
