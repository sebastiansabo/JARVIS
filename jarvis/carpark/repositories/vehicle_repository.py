...
VEHICLE_UPDATABLE_FIELDS = {
    ...
    'body_type', 'year_of_manufacture', 'manufacture_date', 'first_registration_date',
    'color_exterior', 'color_code', 'color_interior', 'interior_code',
    'interior_material', 'color_finish',
    'consum_urban', 'consum_extraurban', 'consum_mixt',
    'electric_range_km', 'previous_owners', 'country_of_origin',
    'fuel_type', 'transmission', 'drive_type', 'engine_displacement_cc',
    'fuel_tank_capacity_liters', 'battery_capacity_kwh',
    'norma_combustibil', 'norma_energie',
    ...
    'payload_kg', 'cargo_volume_m3', 'cargo_length_mm', 'cargo_width_mm',
    'cargo_height_mm', 'euro_pallets',
    'equipment', 'optional_packages', 'equipment_options',
    ...
    'is_right_hand_drive', 'has_particle_filter', 'is_vintage',
