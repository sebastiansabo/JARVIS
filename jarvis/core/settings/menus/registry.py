...
MODULES = [
    ...
    },
    {
        ...
        'children': [
            ...
            {'module_key': 'accounting_facturare', 'name': 'Comenzi Externe', 'description': 'Manage contracts, anexas, and invoices', 'icon': 'bi-receipt', 'url': '/accounting/facturare', 'sort_order': 5},
